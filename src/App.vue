              ...
              transform: {
                keys: {
                  o: [
                    {
                      t: 760,
                      v: { x: 45.908115, y: 445.261719, type: 'corner' },
                    },
                    {
                      t: 910,
                      v: { x: 26.236544, y: 466.64386, type: 'corner' },
                    },
                    { t: 1060, v: { x: 45.908114, y: 445.26, type: 'corner' } },
                  ],
                },
              },
            },
          },
          s: '|',
        },
      ],
      options: 'MVDAxMDg4MmY4MDgxSDVZlN2Y4MTJmNDcyZjcN5N2M2ZTcxRzJmOGE/E',
    },
    '__SVGATOR_PLAYER__',
    window,
    document
    ...
    <a href="https://vuejs.org/" target="_blank">
      ...
      >
        <text
          ...
          font-size="302"
          font-weight="400"
          transform="translate(28.6872 248.681)"
          fill="2d2153"
        >
          <tspan
            font-family='"MontBlanc-Trial-Bold"'
        ...
        <text
          ...
          font-size="302"
          font-weight="400"
          transform="translate(26.0487 466.681)"
          fill="2d2153"
        >
          B
        </text>
        <text
          ...
          font-size="302"
          font-weight="400"
          transform="translate(219.049 461.681)"
          fill="2d2153"
        >
          <tspan
            font-family='"MontBlanc-Trial-Bold"'
        ...
        <text
          ...
          font-size="302"
          font-weight="400"
          transform="translate(45.908115 445.261719)"
          fill="#fff"
        >
          <tspan
            font-family='"MontBlanc-Trial-Bold"'
            ...
            font-weight="400"
            font-style="normal"
            transform="translate(50.9608 445.681)"
            fill="#fff"
          >
            B
          </tspan>
